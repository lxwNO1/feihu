...
function initSelectTree(id, isMultiple, chkboxType,treedata,inputname) {
    var setting = {
        view: {
    ...
    var html = '<div class = "layui-select-title" >' +
        '<input id="' + id + 'Show"' + 'type = "text" placeholder = "请选择,不选将被默认为一级节点" value = "" class = "layui-input" lay-verify="required"  required readonly>' +
    ...
    $.fn.zTree.init($("#" + id + "Tree"), setting, treedata).expandAll(true);
}
